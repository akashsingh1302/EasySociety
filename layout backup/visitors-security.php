...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="add_visitors.html">EasySociety</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="add_visitors.html">
            <i class="fas fa-pen-fancy"></i>
            <span>Add Visitors</span>
          </a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="visitors-security.php">
...
?>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><td>" . $row["Date"]. "</td><td>" . $row["VisitorName"] . "</td><td>". $row["VisitorContact"]. "</td><td>". $row["FlatAddress"]. '</td></tr>';
        }
    }
