  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="visitors-user.php">
...
?>
    ...
    <?php
    $sql = "SELECT * FROM visitors where FlatAddress='$flat'";
    $result = $con->query($sql);
    if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["Date"]. "</td><td>" . $row["VisitorName"] . "</td><td>". $row["VisitorContact"]. '</td></tr>';
        }
    }
    echo "</table>";
    $con->close();
