...
$month_year =(string) $_REQUEST["month_year"];
$owner = (string)$_REQUEST["flatowner"];
require('../dbconnection/db.php');
$con = dbconnect();
$sql = "SELECT * from paymenthistory where MonthandYear='$month_year' and FlatOwner='$owner'";
...
?>
         ...
         <div class="card mb-3" style = "width:90%;margin-left:5%;">
            <div class="card-header" style="text-align:center;font-size:20px;font-weight:bold;padding:10px 15px">
              ...
              DETAILED PAYMENT REPORT : <?php echo $month_year  ?> 
            </div> 
            <div class="card-body" style="">
              ...
              <div id="content" class="table-responsive" style="width:80%;margin-left:10%;">
                <table class="table table-dark table-bordered" width="60%;" cellspacing="0">
                  ...
                  <tr><td>Payment Date</td><td><?php echo "$paymentdate" ?></td></tr>
                  <tr><td>Flat Address</td><td><?php echo "$flat" ?></td></tr>
                  <tr><td>Flat Owner</td><td><?php echo "$owner" ?></td></tr>
                  <tr><td><strong>Total Payment(including dues)</strong></td><td><strong><?php echo "$total" ?></strong></td></tr>
   
                </table>
              </div>
              <a href = "paymentreceipt.php" style="text-align:center;margin-left:35%">
              <button type="button" class="btn btn-primary">BACK TO PAYMENT RECEIPTS</button>
              </a>
    ...
    <div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-danger" href="../confirmpayment.php">Confirm</a>
          </div>
        </div>
      </div>
    </div>
