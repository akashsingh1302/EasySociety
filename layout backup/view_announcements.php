...
<html lang="en">
  ...
  <head>
    ...
    <title>Residents - Announcements</title>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link text-white" href="view_announcements.php" >
...
?>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><td>" . $row["Date"]. "</td><td>" . $row["Subject"] . "</td><td>". $row["Message"]. '</td></tr>';
        }
    }
    echo "</table>";
    $con->close();
