...
--
-- Host: localhost:3308
-- Generation Time: Oct 23, 2020 at 06:17 AM
...
CREATE TABLE `bills` (
  `CommonCharges` float NOT NULL,
  `WaterCharges` float NOT NULL,
  `SinkingFund` float NOT NULL,
  `BuildingRepairFund` float NOT NULL,
  `twowheelerParkingCharges` float NOT NULL,
  `fourwheelerParkingCharges` float NOT NULL,
  `InsurancePremium` float NOT NULL,
...
INSERT INTO `bills` (`CommonCharges`, `WaterCharges`, `SinkingFund`, `BuildingRepairFund`, `twowheelerParkingCharges`, `fourwheelerParkingCharges`, `InsurancePremium`, `Others`) VALUES
(1.5, 100, 30, 50, 50, 100, 20, 10);
